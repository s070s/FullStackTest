    ...
    public static class AuthEndpoints
    {
        public static void MapAuthEndpoints(this WebApplication app)
        {
            ...
            ) =>
            {
                ...
                {
                    refreshTokenCookieService.RemoveRefreshToken(httpContext);
                ...
                refreshTokenCookieService.SetRefreshToken(httpContext, tokens.RefreshToken, tokens.RefreshTokenExpiresUtc);
            ...
            ) =>
            {
                ...
                // Expire cookie immediately using the service
                refreshTokenCookieService.RemoveRefreshToken(httpContext);
